if (!window.markCollection || !window.markCollection._colorOptions) {
    ...
    };
    {
        ...
        t = t && "object" == typeof t ? window.markCollection : {}, g.onready = () => {
            t._colorOptions.isReady = !0, $(document).trigger("_coloroptionsisready");
        }, t._colorOptions = {
            ready(t) {
        ...
        }, t.w3color = "function" == typeof window.w3color ? window.w3color : void 0, 
        window.markCollection = t;
    }
    function d(t, o, e) {
    ...
    function h() {
        ...
        $(window).on("mousedown touchstart", t => {
            ...
            t.iframeProperties.document.hasFocus() || e();
        }), $(window).scroll(() => {
            var t;
            t = u, $(t.iframeProperties.iframe).is(":visible") && e(!1);
        });
    }
    function i(n) {
        const r = u;
        ...
        $(s).hide(), $(s).attr("id", a), $(s).attr("title", "Mark Color Options"), 
